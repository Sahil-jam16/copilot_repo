...
app.register_blueprint(my_tickets, url_prefix='/api')
app.register_blueprint(admin_tickets, url_prefix='/api')
app.register_blueprint(cinema, url_prefix='/api')
app.register_blueprint(profile, url_prefix='/api')
app.register_blueprint(upload2, url_prefix='/api')
app.register_blueprint(req_otp, url_prefix='/api')
